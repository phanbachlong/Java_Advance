...
CREATE TABLE `Position` (
    ...
    PositionName			ENUM('Dev','Test','ScrumMaster','PM') NOT NULL UNIQUE KEY, -- mapping trên Java là Enum,
    Deleted					BOOLEAN default false
);
...
CREATE TABLE Exam (
    `Code`					CHAR(10) NOT NULL,	-- L-1: if duration >= 180p, M-1: if duration >= 90p, S-1: otherwise
