    ...
    public static void departmentCRUD() {
        ...
        while (true) {
            ...
            switch (i) {
                ...
                case 3:
                    // Update department
                    int departmentID = ScannerUtills.inputInt("Nhap vao ID cua department muon cap nhat: ");
                    String departmentName = ScannerUtills.inpuString("Nhap vao Name cua department muon cap nhat: ");
                    ...
                    while (isDepartmentName) {
                        departmentName = ScannerUtills.inpuString("Nhap lai Name cua department: ");
